...
![Дашборд codegraph explorer со списками крупнейших доменов, самых используемых символов и мёртвых экспортов](docs/images/explorer-dashboard.png)

*Стартовый дашборд — карточки инсайтов по всему репозиторию, вычисленные из графа.*

![Экран фокуса codegraph explorer для одного узла с зависимыми и зависимостями](docs/images/explorer-focus.png)

*Экран фокуса — один узел, кто зависит от него и от чего зависит он.*
